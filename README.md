...
```
    ...
    Cell In[196], line 1
    ----> 1 chembl_activity['Molecular Weight'] = chembl_activity['Molecular Weight'].astype(float)
          2 chembl_activity['Standard Value'] = chembl_activity['Standard Value'].astype(float)
    

    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\generic.py:6240, in NDFrame.astype(self, dtype, copy, errors)
       6233     results = [
    ...
    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\internals\managers.py:448, in BaseBlockManager.astype(self, dtype, copy, errors)
    ...
    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\internals\managers.py:352, in BaseBlockManager.apply(self, f, align_keys, ignore_failures, **kwargs)
    ...
    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\internals\blocks.py:526, in Block.astype(self, dtype, copy, errors)
        508 """
    ...
    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\dtypes\astype.py:299, in astype_array_safe(values, dtype, copy, errors)
    ...
    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\dtypes\astype.py:230, in astype_array(values, dtype, copy)
    ...
    File ~\anaconda3\envs\co_add\lib\site-packages\pandas\core\dtypes\astype.py:170, in astype_nansafe(arr, dtype, copy, skipna)
